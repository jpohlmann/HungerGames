package com.example.hungermod.entity.model;
...
@OnlyIn(Dist.CLIENT)
public class MockingJayModel extends SegmentedModel<MockingJayEntity> {
     ...
     */
    public void setRotationAngles(MockingJayEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    public void setLivingAnimations(MockingJayEntity entityIn, float limbSwing, float limbSwingAmount, float partialTick) {
    ...
    public void renderOnShoulder(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float p_228284_5_, float p_228284_6_, float p_228284_7_, float p_228284_8_, int p_228284_9_) {
        this.setLivingAnimations(MockingJayModel.State.ON_SHOULDER);
        this.setRotationAngles(MockingJayModel.State.ON_SHOULDER, p_228284_9_, p_228284_5_, p_228284_6_, 0.0F, p_228284_7_, p_228284_8_);
        this.getParts().forEach((p_228285_4_) -> {
            p_228285_4_.render(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn);
        });
    }

    private void setRotationAngles(MockingJayModel.State p_217162_1_, int p_217162_2_, float p_217162_3_, float p_217162_4_, float p_217162_5_, float p_217162_6_, float p_217162_7_) {
    ...
    private void setLivingAnimations(MockingJayModel.State p_217160_1_) {
    ...
    private static MockingJayModel.State getParrotState(MockingJayEntity p_217158_0_) {
        if (p_217158_0_.isPartying()) {
            return MockingJayModel.State.PARTY;
        } else if (p_217158_0_.isSitting()) {
            return MockingJayModel.State.SITTING;
        } else {
            return p_217158_0_.isFlying() ? MockingJayModel.State.FLYING : MockingJayModel.State.STANDING;
        }
    }
