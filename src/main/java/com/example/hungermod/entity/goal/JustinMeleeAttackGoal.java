package com.example.hungermod.entity.goal;
...
public class JustinMeleeAttackGoal extends Goal {
    ...
    public JustinMeleeAttackGoal(CreatureEntity creature, double speedIn, boolean useLongMemory) {
